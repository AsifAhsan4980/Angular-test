...
import { LocalstorageService, NotificationService, ResumeService } from 'src/app/_services';
import { Certificate, Education, General, Skill, Work } from 'src/app/_models';
...
export class DropResumeComponent implements OnInit {
    ...
    saveSkill() {
        ...
        this.isLoading = true;
        this.resumeService.saveResumedata(reqdata).subscribe(
            (data) => {
